...
shinyUI(
  ...
  tabPanel("Mixing Clusters", div(class="outer",
        ...
        absolutePanel(id = "controls", class="panel panel-default", fixed = TRUE,
                          ...
                          textInput("zip", label="", value=90012),
                          actionButton("recenter", label="Click to re-center on 5-digit ZIP"),    
                          ...
                          selectInput("variable", label=h6("-2- Choose a mixing type below for more information:"), selected=" ",
                                      choices=list(" ", "Age", "Race", "Education", "Income", "Housing Age", "Dwelling Unit Type", "Land Use (Overall)", 
                                      "Jobs-Housing L.U.", "Local Services L.U.", "Nuisance Land Use", "Green Space L.U.")),
  ...
  tabPanel("Mixing Values", div(class="outer",
        ...
        absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE, draggable = TRUE, top = 60, left = "auto", 
                      ...
                      p(strong(em("Displays values of mixing (2012 data) and other socioeconomic conditions (year 2000)."))),
                      ...
                      conditionalPanel("input.analysis == 1",
                                       selectInput("mix", label=strong("Select Mixing Type:"), choices=list("Age", "Race", "Education", "Income", "Dwelling Unit Age", "Housing Type", "Land Use (Overall)"), selected="Age"),
